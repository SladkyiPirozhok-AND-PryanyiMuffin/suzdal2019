...
pub fn get_default_char_codes() -> Vec<CharEncoding> {
	vec![
		...
		CharEncoding { data: 257u16, text: vec![String::from("А"), String::from("А"), String::from("а")] },
		CharEncoding { data: 258u16, text: vec![String::from("Б"), String::from("Б"), String::from("б")] },
		CharEncoding { data: 259u16, text: vec![String::from("В"), String::from("В"), String::from("в")] },
		CharEncoding { data: 260u16, text: vec![String::from("Г"), String::from("Г"), String::from("г")] },
		CharEncoding { data: 261u16, text: vec![String::from("Д"), String::from("Д"), String::from("д")] },
		CharEncoding { data: 262u16, text: vec![String::from("Е"), String::from("Е"), String::from("е")] },
		CharEncoding { data: 263u16, text: vec![String::from("Ё"), String::from("Ё"), String::from("ё")] },
		CharEncoding { data: 264u16, text: vec![String::from("Ж"), String::from("Ж"), String::from("ж")] },
		CharEncoding { data: 265u16, text: vec![String::from("З"), String::from("З"), String::from("з")] },
		CharEncoding { data: 266u16, text: vec![String::from("И"), String::from("И"), String::from("и")] },
		CharEncoding { data: 267u16, text: vec![String::from("Й"), String::from("Й"), String::from("й")] },
		CharEncoding { data: 268u16, text: vec![String::from("К"), String::from("К"), String::from("к")] },
		CharEncoding { data: 269u16, text: vec![String::from("Л"), String::from("Л"), String::from("л")] },
		CharEncoding { data: 270u16, text: vec![String::from("М"), String::from("М"), String::from("м")] },
		CharEncoding { data: 271u16, text: vec![String::from("Н"), String::from("Н"), String::from("н")] },
		CharEncoding { data: 272u16, text: vec![String::from("О"), String::from("О"), String::from("о")] },
		CharEncoding { data: 273u16, text: vec![String::from("П"), String::from("П"), String::from("п")] },
		CharEncoding { data: 274u16, text: vec![String::from("Р"), String::from("Р"), String::from("р")] },
		CharEncoding { data: 275u16, text: vec![String::from("С"), String::from("С"), String::from("с")] },
		CharEncoding { data: 276u16, text: vec![String::from("Т"), String::from("Т"), String::from("т")] },
		CharEncoding { data: 277u16, text: vec![String::from("У"), String::from("У"), String::from("у")] },
		CharEncoding { data: 278u16, text: vec![String::from("Ф"), String::from("Ф"), String::from("ф")] },
		CharEncoding { data: 279u16, text: vec![String::from("Х"), String::from("Х"), String::from("х")] },
		CharEncoding { data: 280u16, text: vec![String::from("Ц"), String::from("Ц"), String::from("ц")] },
		CharEncoding { data: 281u16, text: vec![String::from("Ч"), String::from("Ч"), String::from("ч")] },
		CharEncoding { data: 282u16, text: vec![String::from("Ш"), String::from("Ш"), String::from("ш")] },
		CharEncoding { data: 283u16, text: vec![String::from("Щ"), String::from("Щ"), String::from("щ")] },
		CharEncoding { data: 284u16, text: vec![String::from("Ъ"), String::from("Ъ"), String::from("ъ")] },
		CharEncoding { data: 285u16, text: vec![String::from("Ы"), String::from("Ы"), String::from("ы")] },
		CharEncoding { data: 286u16, text: vec![String::from("Ь"), String::from("Ь"), String::from("ь")] },
		CharEncoding { data: 287u16, text: vec![String::from("Э"), String::from("Э"), String::from("э")] },
		CharEncoding { data: 288u16, text: vec![String::from("Ю"), String::from("Ю"), String::from("ю")] },
		CharEncoding { data: 289u16, text: vec![String::from("Я"), String::from("Я"), String::from("я")] },
